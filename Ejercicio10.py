...
numDoll = int(input("Introduzca el numero de muñecas del ultimo pedido: "))
numClown = int(input("Introduzca el numero de payasos del ultimo pedido: "))

pesoPedido = ((pesoDoll*numDoll)+(pesoClown*numClown))
print(f"El peso total del paquete para el último pedido es de {pesoPedido} g")